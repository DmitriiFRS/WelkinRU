      ...
      <section className={styles.about__main}>
         ...
         <div className={styles.about__titleBody}>
            ...
            <p className={styles.about__subtitle}>
               Welkin Company – Ваш надежный партнёр в сфере бытовой техники в России! Наша компания была основана на
               принципах качества, надежности и профессионализма, и с тех пор мы стремимся делать повседневную жизнь
